...
Вот еще один пример динамическогой подготовки макета для проверки. Его отличие состоит в том, что мы используем области макета для построения нашего собственного табличного документа для проверки:
