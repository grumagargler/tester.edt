...
Procedure loadUserSettings ()
	...
	Collections.Join ( SettingsTable, Reporter.GetUserSettings ( SessionParameters.User, Parameters.ReportName, Parameters.ReportVariant ) );
...
Procedure loadVariants ()
	...
	enddo; 
	Collections.Join ( SettingsTable, Reporter.GetVariants ( SessionParameters.User, Parameters.ReportName ) );
